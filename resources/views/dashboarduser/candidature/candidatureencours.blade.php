        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-header">
              <h3 class="box-title">MES CANDIDATURES EN COURS </h3>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover table-bordered">
                ...
                @foreach ($candidat_encours as $candidature )
                ...
                <tr>
                  ...
                  <td>  <span class="label label-warning">{{$candidature->etat}}</span></td>
                  <td>
