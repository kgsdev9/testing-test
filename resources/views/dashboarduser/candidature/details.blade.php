      ...
      <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <a href="{{route('export.candidature', $candidat['id'])}}" class="btn btn-light btn-rounded">Télécharger au format pdf</a>
              <a href="{{route('modifier_candidature', $candidat['id'])}}" class="btn btn-secondary btn-rounded">Modifier la candidature</a>
              <a href="{{route('delete_candidature',$candidat['id'])}}" class="btn btn-secondary btn-rounded" onclick="return confirm('Voulez-Vous Supprimer Votre Candidature ?')">Supprimer la candidature </a>
           </div>
